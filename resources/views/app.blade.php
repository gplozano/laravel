...
<head>
    ...
    <link href="/static/admin/jquery-ui.min.css" rel="stylesheet" type="text/css">
    <link href="/static/admin/jquery-ui.theme.min.css" rel="stylesheet" type="text/css">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">System Status Admin</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-user fa-fw"></i>  {{{ isset(Auth::user()->name) ? Auth::user()->name : Auth::user()->email }}}<i class="fa fa-caret-down" style="margin-left:8px"></i>
                    </a>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li><a href="/admin/issues"><i class="fa fa-exclamation-triangle fa-fw"></i> Issues</a></li>
                        

                        <!--<li>
                            <a href="issues"><i class="fa fa-exclamation-triangle fa-fw"></i> Issues<span class="fa arrow"></span></a>
                        ...
                        <!--<li>
                            <a href="tollfree"><i class="fa fa-phone fa-fw"></i> Toll Free Numbers</a>
                        </li>-->
